...
1. Read [`adapter_protocol.md`](adapter_protocol.md) —
   the complete contract.
2. Copy [`adapter_server.py`](adapter_server.py) beside your device implementation. Use
   [`mock_adapter.py`](mock_adapter.py) as an example of `summary`, `meta`, `health`, `read`,
