...
conftest auto-discovers qwen_mm_plugins_freecad. Like the blender server it is a THIN
...
FREECAD_SERVER_DIR = os.path.join(REPO_ROOT, "src", "capabilities", "freecad", "qwen_mm_plugins_freecad")
