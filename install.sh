...
CAP_ITEMS=(core api search video-memory omni-memory video-edit blender freecad edu-agent omni-video2note omni-chatcut omni-skill-creator mhs video-spatio)
...
CAP_VERSIONS=(1.1.0 1.1.2 1.1.0 1.1.0 1.1.3 1.1.0 1.1.0 1.1.0 1.1.0 1.0.3 1.0.2 1.0.1 1.1.0 1.0.0)
